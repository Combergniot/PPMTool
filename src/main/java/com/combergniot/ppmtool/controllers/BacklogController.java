...
public class BacklogController {
    ...
    public ResponseEntity<?> updatedProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult bindingResult,
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id){
        ...
        return new ResponseEntity<String>("Project Task " + pt_id + " was succesfully deleted", HttpStatus.OK);
    }
}
